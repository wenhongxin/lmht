...
<template>
	<div id="stubasicinfo">
		<p>
			<span>
				学生姓名<br />
				<input type="text" v-model.trim='studata.realname' />
			</span>
			<span>
				性别<br />
				<select v-model='studata.student_sex'>
			...
			<span>
				年级<br />
				<select  v-model='studata.student_grade'>
					<option value="">请选择</option>
		...
		<p>
			<span>
				紧急联系人<br />
				<input type="text" v-model.trim='studata.urgent_name' />
			</span>
			<span>
				性别<br />
				<select v-model = 'studata.urgent_sex'>
					<option value="">请选择</option>
					<option value="1">男</option>
					<option value="2">女</option>
				</select>
			...
			<span>
				电话<br />
				<input type="text" v-model='studata.urgent_username' />
			</span>
			<span>
				邮箱<br />
				<input type="text" v-model='studata.urgent_email' />
			</span>
			<span>
				微信<br />
				<input type="text" v-model.trim='studata.urgent_wechat' />
			</span>
		</p>
		<p>
			<span>
				家长姓名<br />
				<input type="text" v-model.trim='studata.jiazhang_name' />
			</span>
			<span>
				性别<br />
				<select v-model.trim='studata.jiazhang_sex'>
					<option value="">请选择</option>
					<option value="1">男</option>
					<option value="2">女</option>
				</select>
			...
			<span>
				电话<br />
				<input type="text" v-model.trim='studata.jiazhang_username' />
			</span>
			<span>
				邮箱<br />
				<input type="text" v-model.trim = 'studata.jiazhang_email' />
			</span>
			<span>
				微信<br />
				<input type="text"  v-model.trim = 'studata.jiazhang_wechat' />
			</span>
		</p>
		<p>
			<span>
		...
		<p class="home">
			家庭环境<br />
			<textarea v-model.trim='studata.jiazhang_environment'></textarea>
		</p>
		<p class="tydjy">
			体验店建议<br />
			<textarea v-model.trim='studata.store_proposal'></textarea>
		</p>
